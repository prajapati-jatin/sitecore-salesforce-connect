...
namespace Sitecore.Salesforce.Caching
{
    ...
    public class UserCache : SalesforceCacheBase
    {
        ...
        {
            this.SetString(salesforceUser.Login, salesforceUser.Id);
            this.SetObject(salesforceUser.Id, salesforceUser);
            //base.SetObject(salesforceUser.Login, salesforceUser.Id, TypeUtil.SizeOfString(salesforceUser.Id));
            //base.SetObject(salesforceUser.Id, salesforceUser, salesforceUser.GetDataLength());
        ...
        {
            return GetObject(userKey) as ISalesforceContact;
        }

        public ISalesforceContact GetByName(string userName)
        {
            String key = GetString(userName);
